        ...
        <div className="header-container">
            ...
            <div className="header-options-container">
                <button className="hamburger-btn" type="button" onClick={onClickHamburger} >
                    <GiHamburgerMenu size={20} color="#f2f2f2"/>
                </button>
                <div className="header-options-larger-device">
                    <Link to="/" className="link-style">
                        <h3 className="header-options">Home</h3>
                    </Link>
                    <Link to="/education" className="link-style">
                        <h3 className="header-options">Education</h3>
                    </Link>
                    <Link to="/projects" className="link-style">
                        <h3 className="header-options">Projects</h3>
                    </Link>
                    <Link to="/certificates" className="link-style">
                        <h3 className="header-options">Certificates</h3>
                    </Link>
                    <Link to="/contact" className="link-style">
                        <h3 className="header-options">Contact</h3>
                    </Link>
                </div>  
            </div>
